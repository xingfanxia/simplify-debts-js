...
const messages = {
  'zh-Hans': {
    ...
    addTwoPeopleError: '请先添加至少两个人。', duplicateNameError: '这个名字已经在群组中。', validAmountError: '请输入大于零的有效金额。', choosePayerError: '请选择付款人。', chooseShareError: '请至少选择一位分摊人。', addExpenseBeforeSave: '保存前请先添加一笔支出。', savedAndStartedNew: '已保存“{title}”，可以开始新账单了。', deletePersonConfirm: '删除 {name} 以及与其相关的支出？', resetConfirm: '清空全部成员和支出？',
    ...
    preferences: '设置', currency: '币种', automatic: '自动（当前 {value}）', theme: '外观', systemDefault: '跟随系统', light: '浅色', dark: '深色', privacyTitle: '数据仅保存在本机', privacyBody: '姓名、支出、余额和历史记录不会上传或同步。',
    exampleDinner: '周五晚餐', exampleGroceries: '民宿采购', exampleRide: '回程打车', someone: '某人', paymentFlow: '付款路径', paymentNumber: '付款 {index}', toMove: '待转金额', madeWith: '隐私保护 · 数据仅保存在你的设备上',
