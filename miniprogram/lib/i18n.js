...
const messages = {
  'zh-Hans': {
    ...
    preferences: '设置', currency: '币种', automatic: '自动（当前 {value}）', theme: '外观', systemDefault: '跟随系统', systemShort: '跟随', light: '浅色', dark: '深色', privacyTitle: '数据仅保存在本机', privacyBody: '姓名、支出、余额和历史记录不会上传或同步。',
